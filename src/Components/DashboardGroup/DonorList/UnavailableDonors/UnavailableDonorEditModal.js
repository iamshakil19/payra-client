...
const UnavailableDonorEditModal = ({ editUnavailableDonor, refetch, setEditUnavailableDonor }) => {
    const { donationCount, name, number2, gender, number1, bloodGroup, _id } = editUnavailableDonor
    ...
    return (
        <div>
            <input type="checkbox" id="edit-unavailableDonor-modal" className="modal-toggle" />
            <div className="modal">
                <div className="modal-box">
                    <label onClick={handleContactUpdateData} htmlFor="edit-unavailableDonor-modal" className="btn btn-sm btn-circle bg-[#0F1631] absolute right-2 top-2">✕</label>
...
export default UnavailableDonorEditModal;