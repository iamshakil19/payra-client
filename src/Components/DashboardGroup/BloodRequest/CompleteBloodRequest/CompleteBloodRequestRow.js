            ...
            <td className='p-2 pt-3 pb-1.5'>
                <div className="avatar cursor-pointer">
                    <div className="w-9 rounded-full ring ring-green-500 ring-offset-[#F5F7FF] ring-offset-2">
                        <label onClick={() => setBloodRequestProfileData(completeSingleBloodRequest)} htmlFor="complete-blood-profile-modal" className='cursor-pointer'>
                            <img src={user} alt="" />
                        </label>
                    </div>
                </div>
