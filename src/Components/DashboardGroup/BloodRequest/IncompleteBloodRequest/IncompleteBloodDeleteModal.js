...
const IncompleteBloodDeleteModal = ({ setBloodRequestData, bloodRequestData, refetch }) => {
        ...
        fetch(url, {
            ...
            .then(data => {
                if (data.deletedCount > 0) {
                    ...
                    toast.success('Incomplete Blood Request Data Deleted')
                }
            })
    }
    ...
    return (
        <div className=''>
            <input type="checkbox" id="incomplete-blood-request-delete-modal" className="modal-toggle" />
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box bg-[#F5F7FF]">
                    ...
                    <div className="modal-action">
                        ...
                        <label htmlFor="incomplete-blood-request-delete-modal" className="btn">Cancel</label>
                    </div>
                </div>
            </div>
        </div >
