                ...
                <div class="modal-box bg-[#F5F7FF]">
                    ...
                    <div className='flex justify-center'>
                        <div className='text-start'>
                            <h2 className=' poppins-font mt-2 text-lg'> <span className='bangla-font'>রোগীর নাম: </span> <span className='font-bold text-green-600'>{patient_name}</span> <span className='text-red-500 uppercase ml-2 font-bold'>({requested_bloodGroup})</span></h2>
                            ...
                            <p className='mb-1 bangla-font'>রক্তের পরিমাণ: <span className='font-bold text-red-500'>{blood_quantity}</span> <span className='font-bold'>ব্যাগ</span> </p>
                    ...
                    <div className='flex justify-end mt-3'>
                        <label onClick={() => { setBloodRequestData(bloodRequestProfileData); handleProfileData() }} for="incomplete-blood-request-delete-modal" className='btn btn-sm bg-red-500 border-0 hover:bg-red-600'>Decline</label>
