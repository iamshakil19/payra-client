                    ...
                    <div className="hero-content flex-col md:flex-row-reverse p-0">
                        ...
                        <div className='lg:mr-2 mt-5 lg:mt-0 order-1 md:order-2 p-2'>
                            ...
                            <p className="py-6 lg:w-[600px] text-justify bangla-font">
                                <span className='text-xl text-red-500 font-semibold'>"পায়রা"</span> একটি রক্ত দাতা স্বেচ্ছা সেবী সংগঠন, যার মূল উদ্দেশ্য রক্তের জন্য ভোগা রোগীদের বা তার আত্মীয় স্বজনদের সহজে রক্তের যোগান দেওয়া। রক্ত দানকারী স্বেচ্ছাসেবীরা আমাদের ওয়েব সাইটে রেজিট্রেশন করলে নির্দিষ্ট সময় পরে আমাদের অ্যাডমিনরা তার সাথে যোগাযোগ করে রক্ত দানের জন্য উৎসাহি করবেন।
                                <br />
                                <br />
                                আমরা নানান সময়ে দেখেছি কত মানুষের নির্দিষ্ট একটি রক্তের জন্য হাহাকার। কিন্তু দেখা গেছে ঐ রক্তের দাতার আভাব নেই কিন্তু সঠিক যোগাযোগের অভাবে রোগীকে / রক্ত সংগ্রহকারীকে ভুগতে হয়। আমরা সেই সমস্যা সমাধান করার চেষ্টা করছি মাত্র। রক্ত সংগ্রহকারী আমাদের এডমিনদের ফোনে অথবা ওয়েবসাইটের নির্দিষ্ট ফর্ম পূরণ করে জানালে এডমিনরাই রক্তদাতা খুজে দিবেন অনতিবিলম্বে।
                                <br />
                                <br />
